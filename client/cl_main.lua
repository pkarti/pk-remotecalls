--[[
    ...
    Ther Usage:
        local data = dataRev.execute('dataIndex', 1, 2)
        dataRev.register('dataIndex', function(args1, args2)
            return args1 + args2
        end)
...
remoteCalls.execute = function(name, ...)
    ...
    TriggerServerEvent('pk-remoteCalls:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('pk-remoteCalls:cl_response')
AddEventHandler('pk-remoteCalls:cl_response', function(origin, callId, response)
